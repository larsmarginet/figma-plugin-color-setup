...
module.exports = (env, argv) => ({
  ...
  output: {
    filename: (chunkData) => {
      // Only hash ui.js to ensure --watch updates come true on the ui
      // Plugin can't be hashed or Figma won't recognize it
      return chunkData.chunk.name === 'ui' ? '[name].[hash].js' : '[name].js';
    },
  ...
  plugins: [
    ...
    new HtmlInlineScriptPlugin([/ui.[a-zA-Z0-9]+.js/]),
  ],
});
